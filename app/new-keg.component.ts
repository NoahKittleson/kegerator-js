...
@Component ({
  ...
  <div class="keg-form">
    <h2>Add a Keg</h2>
      <input placeholder="Beer Name" class="col-md-2 input-lg" #newKegName>
      <input placeholder="Type of Beer" class="col-md-2 input-lg" #newKegType>
      <input placeholder="ABV of Beer" class="col-md-2 input-lg" #newKegABV>
